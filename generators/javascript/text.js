...
Blockly.JavaScript['text_charAt'] = function (block) {
    ...
    case 'RANDOM':
        var functionName = Blockly.JavaScript.provideFunction_(
            'text_random_letter', ['function ' + Blockly.JavaScript.FUNCTION_NAME_PLACEHOLDER_ +
              '(text) {',
...
Blockly.JavaScript['text_getSubstring'] = function (block) {
    ...
    if (where1 == 'FIRST' && where2 == 'LAST') {
        ...
        var functionName = Blockly.JavaScript.provideFunction_(
            'text_get_substring', ['function ' + Blockly.JavaScript.FUNCTION_NAME_PLACEHOLDER_ +
...
// client message fuction
Blockly.JavaScript['client_message'] = function (block) {
    var value_client_message = Blockly.JavaScript.valueToCode(block, 'message', Blockly.JavaScript.ORDER_ATOMIC);
    // TODO: Assemble JavaScript into code variable.
    var code = 'clientMessage(' + value_client_message + ');\n';
    return code;
};

// tip message fuction
Blockly.JavaScript['tip_message'] = function (block) {
    var value_client_message = Blockly.JavaScript.valueToCode(block, 'message', Blockly.JavaScript.ORDER_ATOMIC);
    // TODO: Assemble JavaScript into code variable.
    var code = 'ModPE.showTipMessage(' + value_client_message + ');\n';
    return code;
};

// credits block
Blockly.JavaScript['credits'] = function (block) {
    var text_name = block.getFieldValue('name');
    var text_mod = block.getFieldValue('mod');
    var text_web = block.getFieldValue('web');
    var text_twitter = block.getFieldValue('twitter');

    var functionName = Blockly.JavaScript.provideFunction_(
        'credits_block', ['// ------------------------------------------------------------------------------------\n// ' + text_mod + ' developed by ' + text_name + ' using the Bucket O\' Milk ModPE editor (http://milk.mcpestuffs.com) \n// Find more at ' + text_web + ' and follow me at @' + text_twitter + '\n// ------------------------------------------------------------------------------------']);
    return "";
};


// text colour
Blockly.JavaScript['text_colour'] = function (block) {
    var dropdown_colours = block.getFieldValue('colours');
    var code = 'ChatColor.' + dropdown_colours;
    return [code, Blockly.JavaScript.ORDER_ATOMIC];
};
