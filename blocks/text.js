...
Blockly.Blocks['text_length'] = {
    ...
    init: function () {
        ...
        this.setColour(Blockly.Blocks.texts.HUE);
        this.interpolateMsg(Blockly.Msg.TEXT_LENGTH_TITLE, ['VALUE', ['String', 'Array'], Blockly.ALIGN_RIGHT],
            Blockly.ALIGN_RIGHT);
...
Blockly.Blocks['text_isEmpty'] = {
    ...
    init: function () {
        ...
        this.setColour(Blockly.Blocks.texts.HUE);
        this.interpolateMsg(Blockly.Msg.TEXT_ISEMPTY_TITLE, ['VALUE', ['String', 'Array'], Blockly.ALIGN_RIGHT],
            Blockly.ALIGN_RIGHT);
...
Blockly.Blocks['text_indexOf'] = {
     ...
     */
    init: function () {
        var OPERATORS = [[Blockly.Msg.TEXT_INDEXOF_OPERATOR_FIRST, 'FIRST'],
...
Blockly.Blocks['text_charAt'] = {
     ...
     */
    init: function () {
        this.WHERE_OPTIONS = [[Blockly.Msg.TEXT_CHARAT_FROM_START, 'FROM_START'],
...
Blockly.Blocks['text_changeCase'] = {
     ...
     */
    init: function () {
        var OPERATORS = [[Blockly.Msg.TEXT_CHANGECASE_OPERATOR_UPPERCASE, 'UPPERCASE'],
...
Blockly.Blocks['text_trim'] = {
     ...
     */
    init: function () {
        var OPERATORS = [[Blockly.Msg.TEXT_TRIM_OPERATOR_BOTH, 'BOTH'],
...
Blockly.Blocks['text_print'] = {
    ...
    init: function () {
        ...
        this.setColour(Blockly.Blocks.texts.HUE);
        this.interpolateMsg(Blockly.Msg.TEXT_PRINT_TITLE, ['TEXT', null, Blockly.ALIGN_RIGHT],
            Blockly.ALIGN_RIGHT);
        this.setPreviousStatement(true);
        this.setNextStatement(true);
...
Blockly.Blocks['client_message'] = {
    init: function () {
        ...
        this.setPreviousStatement(true);
        this.setNextStatement(true);
        this.setTooltip('Posts a message in the chat');
    }
};
...
Blockly.Blocks['credits'] = {
    init: function () {
        this.appendDummyInput()
            .appendField("By")
            .appendField(new Blockly.FieldTextInput("PocketMines"), "name");
        this.appendDummyInput()
            .appendField("Mod name")
            .appendField(new Blockly.FieldTextInput("Awesome Mod Of Modness"), "mod");
        this.appendDummyInput()
            .appendField("Web")
            .appendField(new Blockly.FieldTextInput("mcpestuffs.com"), "web");
        this.appendDummyInput()
            .appendField("@twitter")
            .appendField(new Blockly.FieldTextInput("imnofox"), "twitter");
        this.setTooltip('');
    }
};

// text colour
// TODO change block colour auto
Blockly.Blocks['text_colour'] = {
    init: function () {
        this.setColour(Blockly.Blocks.texts.HUE);
        this.appendDummyInput()
            .appendField("text colour")
            .appendField(new Blockly.FieldDropdown([["black", "BLACK"], ["dark blue", "DARK_BLUE"], ["dark green", "DARK_GREEN"], ["dark aqua", "DARK_AQUA"], ["dark red", "DARK_RED"], ["dark purple", "DARK_PURPLE"], ["gold", "GOLD"], ["grey", "GRAY"], ["dark grey", "DARK_GRAY"], ["blue", "BLUE"], ["green", "GREEN"], ["aqua", "AQUA"], ["red", "RED"], ["light purple", "LIGHT_PURPLE"], ["yellow", "YELLOW"], ["white (default)", "WHITE"]]), "colours");
        this.setOutput(true, "String");
        this.setTooltip('Changes the following text colour');
    }
};